...
def normal_gravity80(fi,mode=0):
    """
    Calculation of normal gravity (on ellipsoid) wrt GRS80 ellipsoid
...
def disturbing_potential(args):
    """
    Calculation Disturing  potential at given location wrt GRS80 ellipsoid
...
def anomaly_from_ggm(args):
    """
    Calculation gravity anomaly at given location wrt GRS80 ellipsoid
    C,S = fully normalized Stokes coefficients
    n = degree 
    r = location vector
    GM gravity constant of earth (can obtained form GGM)
...
def disturbance_from_ggm(args):
    """
    Calculation gravity disturbance at given location wrt GRS80 ellipsoid
    C,S = fully normalized Stokes coefficients
    n = degree 
    r = location vector
    GM gravity constant of earth (can obtained form GGM)
